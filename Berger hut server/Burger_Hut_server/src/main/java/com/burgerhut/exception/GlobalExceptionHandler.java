...
import com.burgerhut.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleOfferNotFound(OfferNotFoundException ex) {
    ...
    public void handleUnexpectedException(Exception ex, HttpServletRequest request,
                                          HttpServletResponse response) throws IOException {
